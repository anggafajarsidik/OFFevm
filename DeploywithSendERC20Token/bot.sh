...
# Opening
clear
type_out "Starting deployment process..." 0.00003
sleep 0.1
type_out "Initializing scripts and reading configs..." 0.00003
sleep 0.1
type_out "Launching the rocket to the blockchain..." 0.00003
sleep 0.5
type_out "Script Created by :" 0.003
type_out "██████╗ ███████╗███████╗    ███████╗ █████╗ ███╗   ███╗██╗██╗  ██╗   ██╗" 0.00000001
type_out "██╔═══██╗██╔════╝██╔════╝    ██╔════╝██╔══██╗████╗ ████║██║██║  ╚██╗ ██╔╝" 0.00000001
type_out "██║   ██║█████╗  █████╗      █████╗  ███████║██╔████╔██║██║██║   ╚████╔╝" 0.00000001
type_out "██║   ██║██╔══╝  ██╔══╝      ██╔══╝  ██╔══██║██║╚██╔╝██║██║██║    ╚██╔╝" 0.00000001
...
echo ""
type_out "╔══════════════════════════════════════════════════════╗" 0.0000001
type_out "║  ✨   Echoes of code ripple through the chain 🌐💥 ✨     ║" 0.0000001
type_out "╚══════════════════════════════════════════════════════╝" 0.0000001
echo ""
