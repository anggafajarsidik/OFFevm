...
const loadingAnimation = async () => {
  const symbols = ['|', '/', '-', '\\'];
  let i = 0;
  process.stdout.write(purple("Preparing your environment"));
  while (true) {
    process.stdout.write(`\r${purple("Preparing your environment ")} ${symbols[i]}`);
...
const main = async () => {
  ...
  setTimeout(async () => {
    ...
    process.stdout.write("\r✔  All set, starting the process...\n");
  ...
  }, 5000); // End loading after 5 seconds
